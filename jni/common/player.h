...
#if defined(TARGET_ANDROID) && defined(MULTITHREAD)
#define PLAYER_THREAD_JVM   0x80000
#define	PLAYER_PLAY_COMPLETE 0xC1
#define PLAYER_SYNCED		0xC2	
#define PLAYER_ERR			0xC3
#endif
