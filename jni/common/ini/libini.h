...
INI_EXTERN int INI_LINKAGE ini_readInt64 (ini_fd_t fd, int64_t *value);
INI_EXTERN int INI_LINKAGE ini_writeInt64 (ini_fd_t fd, int64_t value);
INI_EXTERN int INI_LINKAGE ini_readBinary (ini_fd_t fd, unsigned char* pvalue,int datalen);
INI_EXTERN int INI_LINKAGE ini_writeBinary (ini_fd_t fd, const unsigned char* pvalue,const int datalen);

#ifdef INI_ENUM
struct key_tag;
INI_EXTERN int INI_LINKAGE ini_setKeyValue(ini_fd_t fd,const char* szKeyName,unsigned char* szValue,unsigned int* size,unsigned int ValueType);
INI_EXTERN int INI_LINKAGE ini_queryKeyValue(ini_fd_t fd,const char* szKeyName,unsigned char* szValue,unsigned int* size,unsigned int *ValueType);
INI_EXTERN int INI_LINKAGE ini_enumKeyValueType(ini_fd_t fd,int no,int* ValueType);
INI_EXTERN int INI_LINKAGE ini_enumKeyValue(ini_fd_t fd,int no,char* szValue,int* size);
INI_EXTERN int INI_LINKAGE ini_enumKeyName(ini_fd_t fd,int no,char* szKey,int* size);
INI_EXTERN int INI_LINKAGE ini_enumKey(ini_fd_t fd,int no,struct key_tag* Key);
INI_EXTERN int INI_LINKAGE ini_enumHead(ini_fd_t fd,int no,char* szHead,int* size);
#endif
