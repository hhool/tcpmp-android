...
struct section_tag *__ini_addHeading    (struct ini_t *ini, char *heading);
struct section_tag *__ini_faddHeading   (struct ini_t *ini, FILE *file, long pos, size_t length);
struct section_tag *__ini_createHeading (struct ini_t *ini, char *heading);
void                __ini_deleteHeading (struct ini_t *ini);
struct section_tag *__ini_locateHeading (struct ini_t *ini, const char *heading);
