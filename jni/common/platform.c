...
{
	return  DEBUG_AUDIO;
	return  DEBUG_TEST|DEBUG_FORMAT|DEBUG_SYS|DEBUG_PLAYER|DEBUG_VIDEO;
	return  DEBUG_VIDEO|DEBUG_PLAYER|DEBUG_SYS|DEBUG_FORMAT|DEBUG_VCODEC;
	return 	DEBUG_TEST|DEBUG_FORMAT|DEBUG_PLAYER|DEBUG_WIN|DEBUG_SYS|DEBUG_VIDEO|
			DEBUG_AUDIO|DEBUG_ACODEC;
	return 	DEBUG_TEST|DEBUG_FORMAT|DEBUG_PLAYER|DEBUG_WIN|DEBUG_SYS|DEBUG_VIDEO|
			DEBUG_AUDIO|DEBUG_VCODEC|DEBUG_ACODEC|DEBUG_VCODEC2;
}
