...
#define LANG_CHS		FOURCC('C','H','S','_')
#define LANG_STD		FOURCC('S','T','D','_')
...
DLL void*   CharTojstring(void*   Env,   char*   str);//string return
DLL char*   jstringToChar(void*   Env,   void*   jStr);//string in
#endif
...
DLL void UTF7ToTcs(tchar_t* Out,size_t OutLen,const char* In);
...
DLL void TcsToUTF7(char* Out,size_t OutLen,const tchar_t* In);
...
DLL void tcslwr(tchar_t* a);
DLL void tcslwrto(tchar_t* s, tchar_t Delimiter);
