...
#if defined(ARM) || defined(MIPS) || defined(SH3) || defined(_M_IX86) || defined(TARGET_ANDROID)
...
#define NOINLINE 
#endif
#if defined(TARGET_WINCE) || defined(TARGET_PALMOS) || defined(TARGET_SYMBIAN) || defined(TARGET_ANDROID)
#define __stdcall
#define STDCALL 
#else
